  ...
  useEffect(() => {
    ...
    const fetchAlerts = async () => {
      try {
        ...
        // Fallback to empty to ensure real data or nothing
        setAlerts([])
      } finally {
        setLoading(false)
      }
      ...
      <div className="container mx-auto px-6 pt-32 pb-12">
        <div className="flex flex-col gap-8">
          <div className="flex-1 space-y-8">
            <h1 className="text-4xl font-black text-white tracking-tighter flex items-center justify-between gap-4">
              ...
              <Button 
                ...
                className="bg-zinc-900 border border-zinc-800 text-white hover:bg-[#5100fd] px-6 h-12 rounded-2xl font-black text-xs uppercase tracking-widest shadow-2xl transition-all"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <StatCard label="Total Balance" value="Live" subValue="Sniper Wallet Balance" />
              <StatCard label="24h Profit" value="Live" subValue="Trading performance" />
              <StatCard label="Active Alerts" value={alerts.length.toString()} subValue="Real-time Solana stream" />
            </div>
