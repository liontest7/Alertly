...
const botUsername = process.env.NEXT_PUBLIC_TELEGRAM_BOT_USERNAME || "Alertly_Solbot";
    ...
    return NextResponse.json(
      {
        ...
        startCommand: `/start ${request.token}`,
        deepLink: `https://t.me/${botUsername}?start=${request.token}`,
      },
      { status: 200 },
    );
  } catch (error) {
