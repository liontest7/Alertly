...
export function Footer() {
  return (
    <footer className="relative z-20 py-12 border-t border-zinc-900 bg-black/10 backdrop-blur-sm">
      <div className="container mx-auto px-6 lg:px-12 flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 rounded-full bg-[#5100fd] flex items-center justify-center overflow-hidden border border-white/10">
            <Image
              src="/images/logo.png"
              alt={siteConfig.name}
              width={40}
